...
public class EmailGameRound3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Button btn4 = errorButton4.GetComponent<Button>();
        btn3.onClick.AddListener(TaskOnClick);
        ...
        else
        {
            ...
            if (numberOfErrors == 0)
            {
                if (score < 2000)
                {
                    ...
                    errorText.text = "You need 2000 points to proceed to next round.";
                    retryButton.SetActive(true);
                }
                else
                {
                    errorText.color = Color.green;
                    errorText.text = "Congratulations! You may proceed to the quiz.";
                    gameOn = false;
